        ...
        <div>
            <div className="carousel w-full h-60 lg:h-[425px] ">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src={sliderPhoto} alt='slider' className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide1" className="btn rounded-lg bg-transparent hover:bg-transparent text-gray-900 border-none"> ❮</a>
                        <a href="#slide3" className="btn rounded-lg bg-transparent hover:bg-transparent text-gray-900 border-none"> ❯</a>
                    </div>
                </div>
