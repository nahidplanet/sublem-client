...
const AddProductBb = () => {
	...
	const handleProductUpload = (e) => {
		...
		const products = { name, code, sortDescription, longDescription, price, discount, color, feature, category, type, productImage }
		const addProductFree = {
			method: 'POST',
			headers: {
		...
		if (products) {
			...
			axiosInst.post('/free',{ name, code, sortDescription, longDescription, price, discount, color, feature, category, type, productImage }).then(res=>{
	...
	return (
		<div className="w-full mx-auto lg:w-1/2 mt-6 pl-0 lg:pl-2">
			...
			<div className="leading-loose">
				<form className="p-10 bg-white rounded shadow-xl" onSubmit={handleProductUpload} >
